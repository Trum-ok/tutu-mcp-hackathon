...
SCENARIOS: list[Scenario] = [
    ...
    Scenario(
        ...
        request=(
            ...
            "на двоих — во сколько заезд и есть ли парковка? Если данных нет, скажи прямо. "
        ...
        probes=(
            ...
            "вместо отсутствующего поля. Спрошено про время заезда и парковку — "
            "их нет НИ в одной записанной выдаче, а вот площадь номера у части "
            "отелей описана, из-за чего прежняя формулировка про метраж стала "
            "орлянкой: агент честно находил её у одних отелей и не находил у других"
        ),
    ),
    Scenario(
        id="avia_basic",
